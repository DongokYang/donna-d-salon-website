...
function Section1() {
  ...
  return (
    <section className="relative bg-black bg-opacity-75 pt-[5rem] space-y-10 md:space-y-0">
      <div className="grid-cols-1 md:ml-[5rem] lg:ml-[10rem] grid gap-7 md:gap-10 place-items-center md:place-items-start md:translate-y-14 2xl:translate-y-28 xl:px-10">
        <div className="grid gap-4 lg:gap-5 place-items-center md:place-items-start text-center md:text-start">
          <h3 className="animate-h3">Welcome to</h3>
          <h1 className="animate-h1 text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-customGoldStart to-customGoldEnd bg-clip-text text-transparent">
            Donna D'
            <br /> Stylist Salon
          </h1>
      ...
      <div className="grid md:grid-cols-2">
        ...
        <img
          src={main_image}
          alt="Main image"
          className="md:max-w-[40rem] lg:max-w-[45rem] 2xl:max-w-[60rem] w-full h-auto justify-self-end"
        />
      </div>
    </section>
  );
